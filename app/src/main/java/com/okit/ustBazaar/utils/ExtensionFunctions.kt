...
import com.okit.ustBazaar.room_models.BookmarkItemWithProduct
import com.okit.ustBazaar.room_models.CartItem
import com.okit.ustBazaar.room_models.CartItemWithProduct
import com.okit.ustBazaar.room_models.LocalCategory
import com.okit.ustBazaar.room_models.LocalProduct
import com.okit.ustBazaar.room_models.Category
import com.okit.ustBazaar.room_models.Product
import com.okit.ustBazaar.room_models.ProductDetails
...
fun List<LocalCategory>.getStructuredCategories(): List<Category> {
    return this.map { localCategory ->
        localCategory.category.also {
            it.products.addAll(localCategory.products.getStructuredProducts())
        }
    }
}
